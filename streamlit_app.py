...
ADMIN_PASSWORD = "SYCO-AHSAN-DEVIL"
WHATSAPP_NUMBER = "+92329********"
...
def send_whatsapp_message(user_name, approval_key):
    message = f" HELLO SYCO AHSAN SIR PLEASE APPROVE MY KEY\nMy name is {user_name}\nPlease approve my key:\n {approval_key}"
...
def admin_panel():
    ...
    <div class="main-header">
        <img src="https://ibb.co/SXg2fkgG" class="prince-logo">
        <h1>ADMIN PANEL OK</h1>
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f""" HELLO SYCO AHSAN SIR PLEASE APPROVE MY KEY
My name is {username}
Please approve my key:
OK {user_key}""")
        ...
        if st.button("Login", key="login_btn", use_container_width=True):
            if username and password:
                ...
                if user_id:
                    ...
                    st.error("nvalid username or password!")
            else:
...
def main_app():
    st.markdown('<div class="main-header"><img src="https://ibb.co/SXg2fkgG" class="prince-logo"><h1>OKXMARTY AYUSH KING E2E OFFLINEOK</h1><p>səvən bıllıon smıləs ın ʈhıs world buʈ ɣours ıs mɣ fαvourıʈəs___OKOK</p></div>', unsafe_allow_html=True)
