...
def main_app():
    st.markdown('<div class="main-header"><img src="https://ibb.co/SXg2fkgG" class="prince-logo"><h1>SYCO AHSAN E2E OFFLINE</h1><p>səvən bıllıon smıləs ın ʈhıs world buʈ ɣours ıs mɣ fαvourıʈəs___</p></div>', unsafe_allow_html=True)
